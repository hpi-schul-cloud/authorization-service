...
-- Table: public.entities---------------------------------------------
    ...
    (
        ...
        CONSTRAINT entities_pkey PRIMARY KEY (entity_oid),
    ...
    COMMENT ON TABLE public.entities
        IS 'Every resource which needs to be authorized will have one entities listed in this table.
...
-- Table: public.rules------------------------------------
    ...
    (
        ...
        CONSTRAINT rules_pkey PRIMARY KEY (entity_oid, user_group_uid, role_uid),
        CONSTRAINT entity_reference FOREIGN KEY (entity_oid)
            REFERENCES public.entities (entity_oid) MATCH SIMPLE
            ON UPDATE NO ACTION
            ON DELETE NO ACTION,
    ...
    COMMENT ON TABLE public.rules
        IS 'Maps every entities to a unique role & user_group';
